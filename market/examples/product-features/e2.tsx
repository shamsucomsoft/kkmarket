...
export default function Example() {
  return (
    <div className="bg-white">
      ...
      <div className="relative  -mt-12  px-4 pb-16 sm:px-6 sm:pb-24 lg:px-8">
        ...
        <dl className=" mt-16 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:max-w-none lg:grid-cols-3 lg:gap-x-8">
