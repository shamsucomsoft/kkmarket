...
export default function Example() {
  return (
    <div className="relative bg-white">
      ...
      <div className="relative  max-w-3xl px-4 pb-96 text-center sm:px-6 sm:pb-0 lg:px-8">
        {/* Background image and overlap */}
        <div
          aria-hidden="true"
      ...
      >
        ...
        <div className=" grid max-w-md grid-cols-1 gap-y-6 px-4 sm: sm:grid-cols-3 sm:gap-x-6 sm:gap-y-0 sm:px-6 lg:gap-x-8 lg:px-8">
